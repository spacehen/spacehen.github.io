...
![\[insert image\]](https://journal.lunar.sh/images/3/valve2.png)

![enter image description here](http://journal.lunar.sh/images/3/07.png)
...
![enter image description here](http://journal.lunar.sh/images/3/01.png)
...
![enter image description here](http://journal.lunar.sh/images/3/02.png)
...
![enter image description here](http://journal.lunar.sh/images/3/10.png)
...
![enter image description here](http://journal.lunar.sh/images/3/04.png)
...
![enter image description here](http://journal.lunar.sh/images/3/11.jpg)
...
![enter image description here](http://journal.lunar.sh/images/3/03.gif)

A bipolar junction transistor (BJT) may be viewed as a combination of two diodes (shown below for an NPN transistor):

![enter image description here](http://journal.lunar.sh/images/3/05.gif)
...
![enter image description here](http://journal.lunar.sh/images/3/06.png)
...
![enter image description here](http://journal.lunar.sh/images/3/07.gif)
...
![enter image description here](http://journal.lunar.sh/images/3/12.jpg)
...
![enter image description here](http://journal.lunar.sh/images/3/08.jpg)
...
![enter image description here](http://journal.lunar.sh/images/3/14.gif)
...
![enter image description here](http://journal.lunar.sh/images/3/15.gif)
...
![enter image description here](http://journal.lunar.sh/images/3/16.gif)
...
![enter image description here](http://journal.lunar.sh/images/3/17.gif)
...
![enter image description here](http://journal.lunar.sh/images/3/18.png)

 A simulation of the DC operating point of the circuit yielded:

![enter image description here](http://journal.lunar.sh/images/3/19.png)
...
There are various circuit configurations used to achieve amplification using transistors, a useful 'template' is known as common emitter configuration (shown below with an NPN transistor):
 ...
 ![enter image description here](http://journal.lunar.sh/images/3/37.png)
...
![enter image description here](http://journal.lunar.sh/images/3/21.png)
...
![enter image description here](http://journal.lunar.sh/images/3/22.png)
...
![enter image description here](http://journal.lunar.sh/images/3/23.png)
...
![enter image description here](http://journal.lunar.sh/images/3/24.png)
...
![enter image description here](http://journal.lunar.sh/images/3/25.png)
...
![enter image description here](http://journal.lunar.sh/images/3/26.png)

Thus, given A<sub>v</sub> = 70, z<sub>out</sub> = 5KΩ we have I<sub>E</sub> = 0.35mA .

We are now able to calculate R<sub>e</sub>:

![enter image description here](http://journal.lunar.sh/images/3/27.png)
...
![enter image description here](http://journal.lunar.sh/images/3/32.png)
...
![enter image description here](http://journal.lunar.sh/images/3/33.png)
...
![enter image description here](http://journal.lunar.sh/images/3/34.png)

This gives R<sub>2</sub> ~= 3.2KΩ

Finally we calculate the value of R<sub>1</sub>:

![enter image description here](http://journal.lunar.sh/images/3/35.png)
...
![enter image description here](http://journal.lunar.sh/images/3/39.png)

Now that we have all the required component values, we build the circuit in LTSpice:

![enter image description here](http://journal.lunar.sh/images/3/38.png)

A simulation of the DC operating point was performed:

![enter image description here](http://journal.lunar.sh/images/3/40.png)
...
![enter image description here](http://journal.lunar.sh/images/3/43.png)
